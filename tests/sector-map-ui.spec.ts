...
test('sector map choices expose wave and hazard readouts before launch', () => {
  ...
  expect(sectorMapScreen).toContain('sectorNodeDecisionIntel(choice)')
  expect(sectorMapScreen).toContain('choice.config.readout')
  ...
  expect(sectorMapScreen).toContain('sector-choice-kind')
  ...
  expect(sectorMapScreen).toContain('${sectorFirstWaveLabel(choice)}</b><em>CONTACT</em>')
  ...
  expect(sectorMapScreen).toContain("button.addEventListener('click', () => runtime.launchSectorNode(node.id))")
