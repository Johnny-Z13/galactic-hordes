...
console.log(`Economy: scrap ${summary.economy.averageScrap.toFixed(1)}, crystal ${summary.economy.averageCrystal.toFixed(1)}, cores ${summary.economy.averageCores.toFixed(1)}, upgrades ${summary.upgrades.averageChosen.toFixed(1)}, unspent signals ${summary.economy.averageMutationSignals.toFixed(1)}`)
