...
function uiClickSoundKindForButton(button: UiClickSoundButton): UiClickSoundKind {
  ...
  if (button.classList.contains('mothership-console-tab')) return 'navigation'
  if (button.classList.contains('meta-department-toggle')) return 'navigation'
  if (button.classList.contains('sector-choice')) return 'confirm'
  if (button.classList.contains('sector-node') && button.classList.contains('available')) return 'confirm'
  if (button.classList.contains('mothership-route-node') && button.classList.contains('available')) return 'confirm'
  if (button.classList.contains('mothership-launch')) return 'confirm'
