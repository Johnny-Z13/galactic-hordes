...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| balanced | 4:00-20:00 | >= 8:00 | <= 65% | >= 1.2 | <= 20% | >= 1.5 |
| survival | 6:00-25:00 | >= 8:00 | <= 50% | >= 0.8 | <= 45% | >= 1.5 |
| planetHunter | 4:00-20:00 | >= 7:00 | <= 70% | >= 2.5 | <= 8% | >= 1.2 |
| greedyCache | 3:00-18:20 | >= 7:00 | <= 80% | >= 1.8 | <= 20% | >= 1.0 |
| routeRusher | 3:40-20:00 | >= 6:00 | <= 70% | >= 0.3 | <= 55% | >= 2.0 |
| stress | 1:00-15:00 | n/a | <= 95% | >= 0.2 | <= 65% | >= 0.8 |
